...
import B_back_office.BackOffice_Srv;
...
public interface MyAPI {
    ...
    static boolean checkIfCertEtcOk() {
        return
                C3_gestion_de_port.objects.MyJSONApi.fichierExiste(BackOffice_Srv.getPath()+"cert_back_office.json") &&
                        C3_gestion_de_port.objects.MyJSONApi.fichierExiste(BackOffice_Srv.getPath()+"private_key.bin") &&
                        C3_gestion_de_port.objects.MyJSONApi.fichierExiste(BackOffice_Srv.getPath()+"public_key.bin") &&
                        MyJSONApi.fichierExiste(BackOffice_Srv.getPath()+"public_key_authority.bin");
    }
}
