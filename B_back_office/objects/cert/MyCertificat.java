package B_back_office.objects.cert;
...
public class MyCertificat implements MyAPI {
    ...
    private String publicKey_php;       // champ utilisé que pour transmettre la clé au format php à travers le certificat
    ...
    public MyCertificat(String test){
        ...
        this.subjectKey = "subjectKey";
        //this.publicKey = ma.getPublic_key();
        this.fingerPrint = "fingerPrint";
    }
