...
public interface MyJSONApi {
     ...
     */
    static void ajouterValeur(JSONObject jo, String clef, int valeur) {
        /*
     ...
     * @param valeur la valeur de la clef
     */
    static void ajouterValeur(JSONObject jo, String clef, String valeur) {
        try {
            jo.put(clef, valeur);
        }
        catch(JSONException jes) {
     ...
     * @param valeur la valeur de la clef
     */
    static void ajouterValeur(JSONObject jo, String clef, Boolean valeur) {
        try {
            jo.put(clef, valeur);
        }
        catch(JSONException jes) {
     ...
     * @param valeur la valeur de la clef
     */
    static void ajouterValeur(JSONObject jo, String clef, JSONObject valeur) {
        try {
            jo.put(clef, valeur);
        }
        catch(JSONException jes) {
     ...
     * @param valeur la valeur de la clef
     */
    static void ajouterValeur(JSONObject jo, String clef, JSONArray valeur) {
        try {
            jo.put(clef, valeur);
        }
        catch(JSONException jes) {
     ...
     * Pour éviter les catch(JSONException partout)
     */
    static JSONArray castinJsonArray(String ja) {
        JSONArray j =null;
        try {
            j = new JSONArray(ja);
        }
    ...
    /**
     * Permet de renvoyer le .toString(int) d'un JSONObject
     */
    static String jsonToString(JSONObject jo, int i) {
        try {
            return jo.toString(i);
        }
        catch(JSONException je) {
            System.out.println("jsonToString() error "+je);
            return "";
        }
    }
    /**
     * Permet de renvoyer le .toString(int) d'un JSONArray
     */
    static String jsonToString(JSONArray ja, int i) {
        try {
            return ja.toString(i);
        }
        catch(JSONException je) {
            System.out.println("jsonToString() error "+je);
            return "";
    ...
    /**
     * Renvoie un JSONObject des données JSON contenu dans le fichier en paramètre
     */
