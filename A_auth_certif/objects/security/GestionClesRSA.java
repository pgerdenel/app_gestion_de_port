...
public class GestionClesRSA {
    ...
    public static void sauvegardeClePublique(PublicKey clePublique, String nomFichier) {
        System.out.println("sauvegardeClePublique() called  "+((clePublique==null)?"key null":"key not null"));
        ...
        try {
            ...
            System.out.println("Exeception à la sauvegardeClePublique 1 clé publique "+e);
        }
        ...
        try {
            ...
            System.out.println("Exeception à la sauvegardeClePublique 2 clé publique "+e);
        }
    }
